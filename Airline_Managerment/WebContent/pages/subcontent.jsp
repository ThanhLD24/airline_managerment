		...
		<script type="text/javascript">
			$(document).ready(
					function() {
						...
						$(".oneway input").click(
								function() {
									$("td.return input").attr("disabled",
											"true").addClass('disabled');

								});
						$(".round-trip input").click(
								function() {
									$("td.return input").removeAttr('disabled')
											.removeClass('disabled');
								});
						...
						$('.sub-form-search input[type=text]').each(function() {
							if ($(this).val() != '')
								$(this).addClass('focus-input');
						});
						$('.sub-form-search input[type=text]').keyup(
								function() {
									if ($(this).val() != '')
										$(this).addClass('focus-input');
									else
						...
						$('.waytype input:checked').each(function() {
							$(this).parent().next().addClass('selected');
						});
						$('.waytype input').click(function() {
							$('.waytype label').removeClass('selected');
